...
livemedia-creator --make-iso --ks auto.ks --no-virt --iso-only --iso-name fedora-$name-live-x86_64.iso --volid Fedora --releasever 43 --resultdir ./result --nomacboot --project "$name f43"
